...
Version Stable 008 :
Ajout/Création : De nouveaux paramètres pour l'anti hack (fichier concerné : init_config_sfp) !
Amélioration : Du fichier creation_des_whitelists_gendarmes_etc.sqf (facilités aux nouveaux administrateurs) !
Correction : Rafraichissement de la mission pour la rendre compatible avec Arma au 24/11/2017 !
Correction : De diverses erreurs suite aux nombreuses mises à jours d'arma !


Version Stable 007 :
Ajout/Création : Les phares de vos véhicules s'allument lorsque vous verrouiller ou déverrouiller vos véhicules !
Modification : De la synchronisation de verrouillage/deverrouillage d'un véhicule !
Correction : Synchronisation des véhicules lorsque vous montez dedans !
Correction : De l'impossibilité de revive aux civils !
