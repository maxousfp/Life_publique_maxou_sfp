...
[
	...
	"----------------------------------------------------------------------------------------------------------------------------------------------------------",
	" CONFIGURATION ANTI HACK",
	"----------------------------------------------------------------------------------------------------------------------------------------------------------",
	format ["Anti Hack Bombardement = %1.", sfp_config_activer_antihack_bombardement],
	format ["Anti Hack Bis_FNC_MP = %1.", sfp_config_activer_antihack_bis_fnc_mp],
	format ["Anti Hack TP = %1.", sfp_config_activer_antihack_TP],
	format ["Anti Hack Argent = %1.", sfp_config_activer_antihack_argent],
	format ["Anti Hack Liste Des Bans = %1.", sfp_config_activer_antihack_automatique_liste_ban],
	format ["Anti Hack ByPass Addon = %1.", sfp_config_activer_antihack_By_Pass_Addons],
	format ["Anti Hack Variables = %1.", sfp_config_activer_antihack_Variables],
	format ["Anti Hack Dialogues = %1.", sfp_config_activer_antihack_Dialogues],
...
_valeur_en_vert = [" CONFIGURATION ANTI HACK", " CONFIGURATION SCRIPTS SERVEUR", " CONFIGURATION DIVERS"," CONFIGURATION DU REVIVE"," CONFIGURATION DES MAISONS"," ADMINISTRATEUR/MODERATEUR/MJ"," CREDIT SFP ET PROGRAMMATION ARGENT"," CONFIGURATION EXTRA VEHICULES","----------------------------------------------------------------------------------------------------------------------------------------------------------"];
